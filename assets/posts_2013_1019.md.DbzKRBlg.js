import{_ as s,c as a,o as e,ag as p}from"./chunks/framework.BeChtK_P.js";const h=JSON.parse('{"title":"关于一些面试题","description":"","frontmatter":{"title":"关于一些面试题","tags":["JavaScript"],"id":1019,"author":"welpher.yu","categories":["web前端"],"date":"2013-04-02T12:50:22.000Z"},"headers":[],"relativePath":"posts/2013/1019.md","filePath":"posts/2013/1019.md"}'),t={name:"posts/2013/1019.md"};function l(i,n,o,r,c,u){return e(),a("div",null,[...n[0]||(n[0]=[p(`<p>1、（js)给如下所有li元素绑定click事件，在鼠标点击的时候alert该li内容、及xy坐标等信息。且在鼠标离开外部ul元素范围时弹出alert提示。要求：注意浏览器兼容性，不要使用现成的框架库。</p><pre>&lt;ul id=&quot;ulitem&quot;&gt;
    &lt;li id=&quot;li1&quot;&gt;内容1&lt;/li&gt;
    。。。重复1000+个li对象...
    &lt;li id=&quot;li9999&quot;&gt;内容9999&lt;/li&gt;
&lt;/ul&gt;</pre><p>解：对于这个题目，考察内容为：事件委托。这么多的li，循环li绑定事件，不知道浏览器会有多卡。直接将事件绑定在ul上，事件冒泡上来就做处理。考虑到兼容性的话，标准浏览器和ie的区别以及dom 2级和1级的区别。事件绑定后，有event的兼容，event.target、event.srcElement；获取内容的话，有兼容性innerText和textContent的区别，关于mouseout兼容的问题，直接看代码。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function mouseover_x ( ae ){  </span></span>
