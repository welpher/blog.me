...
}).listen(7000);</pre><p>输入命令node server.js开启node（记得把nginx reload一下）</p><p>参考：</p><p>1、<a href="http://howtonode.org/how-to-install-nodejs" target="_blank" rel="noreferrer">how to install nodejs</a></p>`,15)])])}const u=n(s,[["render",a]]);export{h as __pageData,u as default};
