import{_ as p,c as t,o as i,j as n}from"./chunks/framework.BeChtK_P.js";const _=JSON.parse('{"title":"在window下安装nginx+php","description":"","frontmatter":{"title":"在window下安装nginx+php","tags":["nginx"],"id":679,"author":"welpher.yu","categories":["服务器"],"date":"2012-01-03T14:26:23.000Z"},"headers":[],"relativePath":"posts/2012/679.md","filePath":"posts/2012/679.md"}'),o={name:"posts/2012/679.md"};function s(r,e,a,l,d,c){return i(),t("div",null,[...e[0]||(e[0]=[n("p",null,"window下安装nginx+php，有时在想，网络上的很多关于这方面的信息，有的好有的差，有的就随便带过。有新手问我配置问题，在远程， 就给他们提供一两篇这方面的信息供其查看。而接着他们按我提供的信息按步操作下来，却有很多情况下出问题。今天就自己把一些安装的关键点提一下，希望对于 那些新手们有所帮助。",-1),n("pre",null,[n("code",null,`一、首先是PHP配置：
...
`)],-1)])])}const x=p(o,[["render",s]]);export{_ as __pageData,x as default};
